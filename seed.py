...
from app import app
from models import db, Tool, CalibrationRecord
...
def seed():
    with app.app_context():
            ...
            if tool.last_calibration_date:
                ...
                if tool.serial_number == "66209685":
                    cal = CalibrationRecord(
                        ...
                        result="pass",
                        notes="WO 2025-WO-1510. Due 7/23/2026.",
                    )
                else:
                    cal = CalibrationRecord(
                        tool_id=tool.id,
        ...
        db.session.commit()
        print(f"Seeded {len(SAMPLE_TOOLS)} tools.")
        print()
